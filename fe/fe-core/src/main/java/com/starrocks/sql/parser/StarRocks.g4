...
booleanExpression
    ...
    | left = booleanExpression IS right = literalExpression                               #isBool
...
predicateOperations [ParserRuleContext value]
    ...
    | NOT? (LIKE | RLIKE | REGEXP | ILIKE) pattern=valueExpression                        #like
    ;
...
unitIdentifier
    ...
    | YEARS | MONTHS | WEEKS | DAYS | HOURS | MINUTES | SECONDS | QUARTERS | MILLISECONDS | MICROSECONDS
    ;
